...
function DownloandLogoTitle() {
  return (
    <View style={{flex: 1, flexDirection:'row',justifyContent: 'space-between', alignItems: 'center', padding:20, marginBottom:0}}>
     <Text> </Text>
     <Text style={{fontSize: 18,  color: '#555555'}} > Dosya İndir</Text>
     <Text> </Text>
   	<TouchableOpacity>
      	   <FontAwesome5 name={'globe-americas'} size={25} color='#555555' />
   	</TouchableOpacity>
  ...
  if(isFirstLauncher=== null){
    ...
    return (
      <NavigationContainer>
        ...
        <Stack.Screen options={{headerShown: false}}  name="Splash" component={Splash} />
        <Stack.Screen options={{headerShown: false}}  name="OnLoginScreen" component={OnLoginScreen} />
          <Stack.Screen options={{headerShown: false, }}  name="AnaSayfa" component={HomeScreen} />
          <Stack.Screen options={{headerShown: false, }}name="DosyaAl" component={FileDownload} />
          <Stack.Screen options={{headerShown: false, }}name="DosyaYukle" component={FileUpload} />
          <Stack.Screen options={{headerShown: false, }} name="DosyaDetay" component={FileDescription} />
          <Stack.Screen options={{headerShown: false, }}name="DosyaPinAl" component={FileInfo} />
          <Stack.Screen options={{headerShown: false, }}name="YardımAl" component={Help} />
          <Stack.Screen options={{headerShown: false, }}name="WebSitesi" component={Web} />
          <Stack.Screen options={{headerShown: false, }}name="DeleteFile" component={DeleteFile} />
          <Stack.Screen options={{headerShown: false, }} name="Download" component={Download} />    
        </Stack.Navigator>
      </NavigationContainer>
